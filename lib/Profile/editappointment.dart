...
class BookAppointment extends State<EditAppointment> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      setState(() {
        emailUser = widget.patientemail;
        nameUser = widget.patientname;
      });
      // }
                      ...
                      ? Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if (lastSelectedIndex != -1 &&
                                  isSelectedList[lastSelectedIndex]) {
                                // delete notification before 3 miniutes
                                print(
                                    "Your appointment with ${nameUser} is on ${widget.previousDay} at ${widget.previousDate} ${widget.previousTime}");
                                print(
                                ...
                                FirebaseFirestore.instance
                                    ...
                                    .where('title',
                                        isEqualTo:
                                            "Reminder you have an appointment after a few minutes")
                                    .where('useremail', isEqualTo: emailUser)
                                ...
                                //*********************** */
                                final ress = await Api.deleteppointmentbyid(
                                    widget.appoinmentid);
                                String selecteddate =
                                ...
                                if (response.statusCode == 200) {
                                  ...
                                  var data3 = {
                                    ...
                                    "content":
                                        "Your reservation with ${nameUser} has been changed to ${selectday} at ${selecteddate} $lastSelectedTimeLabel.",
                                    "title": "Appointment Update",
                                    "date":
